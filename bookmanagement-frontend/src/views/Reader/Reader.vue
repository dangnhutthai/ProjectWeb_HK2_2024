...
<script>
import ContactCard from "@/components/Reader/ReaderCard.vue";
import InputSearch from "@/components/InputSearch.vue";
import ContactList from "@/components/Reader/ReaderList.vue";
...
export default {
  ...
  computed: {
    ...
    contactStrings() {
      return this.contacts.map((contact) => {
        const { madocgia, holot, ten, diachi, dienthoai, phai } = contact;
        return [madocgia, holot, ten, diachi, dienthoai, phai].join("");
      });
    },
  ...
  methods: {
    ...
    goToAddContact() {
      this.$router.push({ name: "reader.create" });
    },
  },
  mounted() {
    this.refreshList();
